...
public class OSSConfig {
    ...
    public static final String BUCKET_NAME = "micronet-link";
    public static final String OSS_ACCESS_KEY_ID = "LTAI5tJS31Re4BWfjBVuN4Uj";
    public static final String OSS_ACCESS_KEY_SECRET = "xiWanpAeAO0689VzXTSTCzRBn6gcDG";
